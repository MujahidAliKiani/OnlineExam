...
namespace OnlineExamSystem.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update OnlineExamSystemDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update OnlineExamSystemEfCoreEntityExtensionMappings to extend the IdentityUser entity
